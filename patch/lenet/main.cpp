...
static void loadImagesAndPreprocess(const std::vector<std::string> &filenames,
  ...
  for (unsigned n = 0; n < numImages; n++) {
    volatile static float imageT[784]= {0};
    if (filenames[n].find("0_1009.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr0[i];
      }
    }
    else if (filenames[n].find("1_1008.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr1[i];
      }
    }
    else if (filenames[n].find("2_1065.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr2[i];
      }
    }
    else if (filenames[n].find("3_1020.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr3[i];
      }
    }
    else if (filenames[n].find("4_1059.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr4[i];
      }
    }
    else if (filenames[n].find("5_1087.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr5[i];
      }
    }
    else if (filenames[n].find("6_1099.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr6[i];
      }
    }
    else if (filenames[n].find("7_1055.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr7[i];
      }
    }
    else if (filenames[n].find("8_1026.png") != std::string::npos) {
      for(int i = 0; i< 784; i++){
        imageT[i] = arr8[i];
      }
    }
    else if (filenames[n].find("9_1088.png") != std::string::npos){
      for(int i = 0; i< 784; i++){
        imageT[i] = arr9[i];
      }
    }
